...
$(document).ready(function() {
    ...
    $.get( "/overview/pillars/api", function( results ) {
        ...
        deskundigheidBackgroundColors = [];
        deskundigheidBorderColors = [];
        organisatieBackgroundColors = [];
        organisatieBorderColors = [];
        results.forEach(function(result){
            ...
            deskundigheidBackgroundColors.push('rgba(249,178,51, 0.7)');
            deskundigheidBorderColors.push('rgba(249,178,51, 1)');
            organisatieBackgroundColors.push('rgba(0, 0, 0, 0.7)');
        ...
        var myChart = new Chart(ctx, {
          ...
          data: {
            ...
            datasets: [{
                label: 'Hardware',
                data: results.map(o => o.totaal.hardware),
              ...
              },
              {
                ...
                data: results.map(o => o.totaal.software),
              ...
              {
                label: 'Deskundigheid',
                data: results.map(o => o.totaal.deskundigheid),
                backgroundColor: deskundigheidBackgroundColors,
                borderColor: deskundigheidBorderColors,
                borderWidth: 2
              },
              {
                label: 'Organisatie',
                data: results.map(o => o.totaal.organisatie),
                backgroundColor: organisatieBackgroundColors,
                borderColor: organisatieBorderColors,
                borderWidth: 2
              }
            ]
          },
